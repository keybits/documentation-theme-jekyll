...
keywords: documantation homepage
tags: [getting_started]
toc: false
sidebar: mydoc_sidebar
permalink: index.html
summary: Ship better code, faster, with CircleCI. The modern Continuous Integration (CI) and Continuous Delivery (CD) platform. Learn from our knowledge base and documentation to get up and running fast.
---

<div class="row">
         <div class="col-lg-12">
             <h2 class="page-header">CircleCI Knowledge Base</h2>
         </div>
         <div class="col-md-3 col-sm-6">
             <div class="panel panel-default text-center">
                 ...
                 <div class="panel-body">
                     <h3>CircleCI 1.0</h3>
                     <p>1.0 is the default platform for most customers<br />&nbsp;</p>
                     <a href="v1_introduction" class="btn btn-primary">1.0 Docs</a>
                 </div>
             </div>
         </div>
         <div class="col-md-3 col-sm-6">
...
This site is using Jekyll which allow for an easy transition from our current docs site. It's using the MIT licensed [Documentation Theme Jekyll](http://idratherbewriting.com/documentation-theme-jekyll/). The theme is stable, [well maintained on GitHub](https://github.com/tomjohnson1492/documentation-theme-jekyll) and provides many useful features.

## TODO

### Search

We will use [Algolia](https://www.algolia.com/) for search. Some benefits of Algolia:

- Very fast results - see [this example on VueJS docs](http://vuejs.org/v2/guide/)
- Categorised results to make clear which section docs are in (see above example)
- Excellent [analytics and stats](https://www.algolia.com/doc/guides/analytics/analytics-overview/) on what people search for
- They have a [Jekyll plugin](https://github.com/algolia/algoliasearch-jekyll) that makes getting good search results customizable and straightoforard
- Search form can be used on Zendesk / elev.io to help provide context senstitive docs results when people are looking for support

### Design

Adapt the design to fit with CircleCI guidelines

### Content Structure

Confirm content hierarchy and structure.

### Content migration

Move 1.0, 2.0 and Enterprise docs into this format

### SEO

- 301 Redirects from 1.0 and Enterprise docs pages
- Sitemap.xml (auto-generated but check)
- Robots.txt and analytics tags
